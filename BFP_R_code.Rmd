...
```{r #+# RV vs VIX build and visual inspection + CREATE rv_vix_subset}
...
##---## build a loop
  ...
  # build a model
  # compare the model prediction with the truth (9d after the interval)
...
T_out <- 5
for (i in (0:0)) {}
  subset = build_vix9_rv_subset(start_date, "2018-03-22")
