...
```{r DATA upload and rv for SPX creation and formatting, eval=FALSE, include=FALSE}
...
```{r plot data violins, eval=FALSE, include=FALSE}
...
```{r FUNCTION return, eval=FALSE, include=FALSE}
...
```{r RV vs VIX with returns build up and visual inspection, eval=FALSE, include=FALSE}
...
```{r another plotting (two y axis), eval=FALSE, include=FALSE}
...
```{r exploratory data analysis SP_500/ VIX/ rv joint DF creation, eval=FALSE, include=FALSE}
...
```{r SP_500/ VIX/ rv correlation, eval=FALSE, include=FALSE}
M<-cor(SP_500_corr_df[,-c(1)])
corrplot(M, type = "upper", tl.col = "steel blue")

```

```{r STAN model AR(1), eval=FALSE, include=FALSE}
...
```{r STAN model ARCH(1), eval=FALSE, include=FALSE}
...
```{r STAN model GARCH(1), eval=FALSE, include=FALSE}
...
```{r STAN model RealGARCH(1,1), eval=FALSE, include=FALSE}
...
```{r plots sd_9/30d_lead9/30d ~ vix9/30 two y axis, eval=FALSE, include=FALSE}
...
```{r FUNCTION build_vix9_rv_subset, eval=FALSE, include=FALSE}
...
```{r FUNCTION quality_of_fit, eval=FALSE, include=FALSE}
...
```{r FUNCTION forecast_vix, eval=FALSE, include=FALSE}
...
```{r chain of forecasts AR1, eval=FALSE, include=FALSE}
...
```{r chain of forecasts ARCH1, eval=FALSE, include=FALSE}
...
```{r chain of forecasts GARCH11, eval=FALSE, include=FALSE}
...
```{r chain of forecasts RealGARCH11, eval=FALSE, include=FALSE}
...
```{r prediction of absolute numbers, eval=FALSE, include=FALSE}
start_date = "2017-01-22"
